...
public class SchedledConfiguration {
    ...
    public MethodInvokingJobDetailFactoryBean detailFactoryBean(@Qualifier("scheduledTasks2")ScheduledTasks scheduledTasks){
    ...
    @Bean
    public SchedulerFactoryBean schedulerFactory(@Qualifier("cronTriggerBean")Trigger cronTriggerBean){
        SchedulerFactoryBean bean = new SchedulerFactoryBean ();
        System.err.println (cronTriggerBean);
